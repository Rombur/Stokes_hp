...
namespace hp_Stokes
{
	...
	private:
		...
		bool cell_is_on_patch (const typename hp::DoFHandler<dim>::cell_iterator &cell);
		bool cell_is_NOT_on_patch (const typename hp::DoFHandler<dim>::cell_iterator &cell);
