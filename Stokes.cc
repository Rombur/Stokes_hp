...
namespace hp_Stokes
{
	...
	StokesProblem::StokesProblem(): Tolerance (0.00001), max_degree (5), dof_handler(triangulation)
	...
	/*......................................................................................*/
	bool StokesProblem::decreasing (pair<double,hp::DoFHandler<2> > &i, pair<double,hp::DoFHandler<2> > &j) 
	{
		return ((i.first) > (j.first));
	}
	/*......................................................................................*/
	bool StokesProblem::cell_is_on_patch (const typename hp::DoFHandler<2>::cell_iterator &cell)
	{
		return (cell->material_id() == patch_on);
	}
	/*......................................................................................*/
	bool StokesProblem::cell_is_NOT_on_patch (const typename hp::DoFHandler<2>::cell_iterator &cell)
	{
	...
	/*......................................................................................*/
	void StokesProblem::estimate (Vector<double> &est_per_cell) {
		...
		for (; cell!=endc; ++cell,++cell_index)
		{
			...
			for (unsigned int face_number=0; face_number<GeometryInfo<2>::faces_per_cell; ++face_number)
				...
				if ((cell->face(face_number)->at_boundary()==false)	&& (cell->face(face_number)->has_children() == false) && (cell->face(face_number)->level() == cell->level()))
				{
					...
					{
						for (unsigned int i=0; i<2; ++i){
							jump_per_face[q][0] += (gradients[q][i]- neighbor_gradients[q][i])*(fe_face_values.normal_vector(q)[0]);		
							jump_per_face[q][1] += (gradients[q][i]- neighbor_gradients[q][i])*(fe_face_values.normal_vector(q)[1]);		
						}// i
	...
	/*......................................................................................*/
	vector<hp::DoFHandler<2>::active_cell_iterator> StokesProblem::get_patch_around_cell(const typename hp::DoFHandler<2>::active_cell_iterator &cell)   
	{
	...
	/*..............................................................................................................................................*/
	vector<hp::DoFHandler<2>::active_cell_iterator> StokesProblem::get_cells_at_coarsest_common_level (const vector<hp::DoFHandler<2>::active_cell_iterator>  &patch)
	{
	...
	/*.....................................................................................................................................*/
	void StokesProblem::build_triangulation_from_patch (const vector<hp::DoFHandler<2>::active_cell_iterator>  &patch,
		Triangulation<2> &tria_patch, unsigned int &level_h_refine, unsigned int &level_p_refine )
	{
		...
		for (typename Triangulation<2>::cell_iterator cell = tria_patch.begin(); cell != tria_patch.end(); ++cell)
		{
			...
			for (vector<hp::DoFHandler<2>::active_cell_iterator>::const_iterator p=patch.begin();
					p != patch.end(); ++p)
				if (*p == global_cell)
				{
	...
	void StokesProblem::h_patch_conv_load_no (double &h_convergence_est_per_cell, unsigned int &h_workload_num, typename hp::DoFHandler<2>::active_cell_iterator const &cell) const
	{
		Triangulation<2> tria_patch;//
		...
		void StokesProblem::p_patch_conv_load_no (double &p_convergence_est_per_cell, unsigned int &p_workload_num, const typename hp::DoFHandler<2>::active_cell_iterator &cell ) const
		{
			Triangulation<2> tria_patch;//
			hp::DoFHandler<2> dof_handler_patch;//
