                                                 ...
                                                 CopyData<dim> const &copy_data)
{
  ...
  //std::cout<<std::endl;
  //std::cout<< " h_conv_est_per_cell " << copy_data.h_conv_est_per_cell <<
  //" ,  " << " p_conv_est_per_cell " << copy_data.p_conv_est_per_cell << std::endl;
  ...
  //std::cout<< " h_improv " << h_improv << "  ,  " << " p_improv " << p_improv << std::endl;
  double h_ratio;
  double p_ratio;

  h_ratio= h_improv/copy_data.h_workload;
  p_ratio= p_improv/copy_data.p_workload;
